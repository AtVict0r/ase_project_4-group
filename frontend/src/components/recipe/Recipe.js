...
const Recipe = ({
  ...
  const fetchRecipes = useCallback(async () => {
    try {
      ...
      const response = await fetch(`${api}/api/recipes/get_all`);
  ...
  const handleAddRecipe = async (newRecipe) => {
    try {
      const response = await fetch(`${api}/api/recipes/add`, {
        method: "POST",
        headers: {
  ...
  const handleUpdateRecipe = async (recipeId, updatedRecipe) => {
    try {
      const response = await fetch(`${api}/api/recipes/update/${recipeId}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          "X-CSRFToken": csrfToken,
